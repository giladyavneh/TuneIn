    ...
    const [likeButton,setLikeButton]=useState(liked)
        ...
        <div className="SongListItem">
            ...
            <div className="player">
                ...
                <button className="like" onClick={like}><img alt="like" src={likeButton?"https://www.flaticon.com/svg/static/icons/svg/833/833386.svg":"https://www.flaticon.com/svg/static/icons/svg/833/833300.svg"}></img></button>
